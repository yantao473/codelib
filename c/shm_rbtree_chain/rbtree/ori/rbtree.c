 ...
 */
static Node* iterative_search(RBTree x, int key) {
 ...
 *     right 是右孩子。
 */
static Node* create_rbtree_node(int key, Node *parent, Node *left, Node* right) {
    Node* p;
 ...
 *                1，表示该节点是它的父结点的右孩子。
 */
static void rbtree_print(RBTree tree, int key, int direction) {
    if(tree != NULL) {
